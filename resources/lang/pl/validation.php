...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'login' => [
            'required' => 'Pole numeru PESEL jest wymagane.'
        ],
        'password' => [
        ...
        '*.multiplier.multiplier_value' => [
            'min' => [
                'array' => 'The :attribute field must have at least :min items.',
                'file' => 'The :attribute field must be at least :min kilobytes.',
                'numeric' => 'Mnożnik musi mieć wartość minimum 1!',
                'string' => 'The :attribute field must be at least :min characters.',
            ],
        ...
        'pesel' => [
            ...
            'required' => 'Pole PESEL jest wymagane.'
        ],
        'value' => [
            'min' => [
                'array' => 'The :attribute field must have at least :min items.',
                'file' => 'The :attribute field must be at least :min kilobytes.',
                'numeric' => 'Liczba punktów musi być więszka lub równa :min.',
                'string' => 'The :attribute field must be at least :min characters.',
            ],
            'numeric' => 'Pole musi być liczbą.'
        ],
        'bonus.family_recommendation.bonus_value' => [
            'integer' => 'Bonus za polecenie rodziny musi być liczbą całkowitą.',
            'min' => 'Wartość bonusu musi być większa lub równa :min'
        ],
        'bonus.caretaker_recommendation.bonus_value' => [
            'integer' => 'Bonus za polecenie rodziny musi być liczbą całkowitą.',
            'min' => 'Wartość bonusu musi być większa lub równa :min'
        ],
