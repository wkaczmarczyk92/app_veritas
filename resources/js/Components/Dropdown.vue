...
<template>
    <div class="tw-relative">
        <div @click="open = !open" class="tw-relative">
            <slot name="trigger" />
        </div>
        ...
        <transition enter-active-class="tw-transition tw-ease-out tw-duration-200"
            ...
            <div v-show="open" class="tw-absolute tw-z-50 tw-mt-2 tw-rounded-md tw-shadow-lg"
                :class="[widthClass, alignmentClasses, custom_class]" style="display: none" @click="open = false">
