            ...
            <div class="tw-flex tw-justify-between tw-h-16">
                <div class="tw-flex">
                    ...
                    <div class="tw-shrink-0 tw-flex tw-items-center">
                        <Link :href="route('home.index_free_account')">
                    ...
                    <div class="tw-hidden tw-space-x-8 lg:-tw-my-px lg:tw-ml-10 lg:tw-flex">
                        <NavLink :href="route('home.index_free_account')"
                            :active="route().current('home.index_free_account')">
                            Strona główna
                        </NavLink>
                        <div
                            ...
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    <DropdownLink :href="route('offer.index_free_account')"> Szukaj ofert
                                    </DropdownLink>
                                    <DropdownLink :href="route('offer.my_offers_free_account')"> Moje zgłoszenia
                                    </DropdownLink>
                                </template>
                            </Dropdown>
                        </div>
                        <div
                            ...
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    <DropdownLink :href="route('userprofile.show')"> Moje konto
                                    </DropdownLink>
                                    <!-- <DropdownLink :href="route('offer.my_offers_free_account')"> Zgłoszenia na oferty
                                    </DropdownLink> -->
                                    <DropdownLink :href="route('password.edit')"> Zmień hasło
                                    </DropdownLink>
                                </template>
                            </Dropdown>
                        </div>
