    ...
    <UserLayoutNoCRMAccount>
        ...
        <div class="tw-py-12">
            <div class="tw-p-4 tw-mx-auto tw-max-w-7xl sm:tw-px-6 lg:tw-px-8 ">
                ...
                <v-card class="!tw-shadow-xl !tw-mt-4">
                    <v-card-text>
                        <div class="tw-text-2xl tw-font-bold tw-text-justify">
                            Chcesz widzieć tylko idealne oferty?

                            <!-- Dołącz do grona <span class="tw-text-blue-600 tw-font-bold">opiekunek premium</span> i
                            zyskaj
                            dostęp
                            do ofert
                            idealnie dopasowanych do
                            Ciebie! Dzięki
                            <span class="tw-text-blue-600 tw-font-bold">kontu premium</span> zobaczysz propozycje pracy,
                            które
                            uwzględniają Twoje doświadczenie, umiejętności oraz
                            preferencje. Nie trać czasu na przeglądanie nieodpowiednich ofert – wybierz <span
                                class="tw-text-blue-600 tw-font-bold">premium</span> i znajdź
                            wymarzoną pracę szybciej!
                        </div>
                        <div class="tw-mt-4 tw-text-lg tw-indent-8 tw-text-justify">
                            Chcesz dowiedzieć się, jak założyć konto <span
                                class="tw-text-blue-600 tw-font-bold">premium?</span> Przejdź <a
                                :href="route('premium.index')"
                                class="tw-text-rose-600 hover:tw-text-rose-400 tw-font-bold">tutaj</a> i dowiedz się
                            więcej. -->
                        </div>
                        <div class="tw-text-lg tw-indent-8 tw-text-justify tw-mt-4">
                            Dzięki kontu premium uzyskasz dostęp do bardziej dopasowanych propozycji niż w obecnym
                            wyszukiwaniu.
                            Odblokuj pełne dopasowanie z premium. <a :href="route('premium.index')"
                                class="tw-text-[#fc9003] hover:tw-underline tw-font-bold">Jak to działa?</a>
                        </div>
                    </v-card-text>
                </v-card>
                <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-4 tw-mt-4">
                    ...
                    <Transition mode="out-in">
                        ...
                        <div v-else class="tw-w-full tw-flex tw-flex-col tw-gap-4">
                            <Transition mode="out-in">
                                <v-alert v-if="offers.length == 0" type="info">Brak ofert spełniających podane
                                    kryteria.</v-alert>
