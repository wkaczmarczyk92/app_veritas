...
<template>
    ...
    <section class="tw-relative tw-pt-16 tw-overflow-hidden tw-bg-gray-100 tw-rounded tw-shadow-xl sm:tw-rounded-lg">
            ...
            <div class="tw-w-full sm:tw-w-4/5 md:tw-w-4/6 lg:tw-w-1/2 svg-container">
                ...
                <div class="tw-flex tw-flex-row points-counter tw-justify-left"
                    ...
                    <p class="tw-flex-row tw-hidden tw-text-gray-800 md:tw-flex">
                        <count-up :duration="4" :end-val="userStore.user.user_profiles.total_points" :options="options"
        ...
        <div class="tw-w-full tw-px-6 tw-py-20 tw-text-center tw-text-gray-800 tw-bg-gray-800 tw-mt-28">
            ...
            <MButton bg="tw-bg-transparent" :value="level(levels, userStore.user.user_profiles.level).toUpperCase()"
            ...
            <h2 class="tw-mt-6 tw-text-xl tw-font-bold tw-text-gray-100 sm:tw-text-2xl"
                ...
                -
                <span>
                    {{ userStore.user.user_profiles.total_points ?? 0 }} / {{ levels[(userStore.user.user_profiles.level < 3
                        ? userStore.user.user_profiles.level : 3)].checkpoints.checkpoint }} </span>
            </h2>
