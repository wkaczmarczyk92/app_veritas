...
const submit = async () => {
    ...
    let response = await axios.post(route('course_moderator.compendium.store'), { ...form.value })
    ...
    <CourseModeratorLayout>
        ...
        <MainContent>
            <div class="tw-grid lg:tw-grid-cols-2 tw-grid-cols-1 tw-gap-4">
                <v-card :loading="form.progress" title="Dodaj nowe kompendium" subtitle="podstawowe dane"
                    class="!tw-p-4">
