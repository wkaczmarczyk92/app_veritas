...
<template>
    ...
    <AdminLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-200 leading-tight">Punkty kontrolne</h2>
        </template>
            ...
            <div class="max-w-4xl mx-auto sm:px-6 px-4 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="font-semibold text-lg text-gray-800 leading-tight mb-6">Aktualne punkty kontrolne</h3>
                        ...
                        <hr class="my-5">
                        <h3 class="font-semibold text-lg text-gray-800 leading-tight mb-6">Aktualizuj punkty kontrolne</h3>
                        ...
                        <form @submit.prevent="submit()" class="mt-4">
                            <div v-for="(item, index) in form.levels" class="mt-4">
                                ...
                                <InputError class="mt-2" :message="form.errors[`${index}.checkpoints.checkpoint`]" />
                            </div>
