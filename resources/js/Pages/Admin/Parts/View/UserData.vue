...
<template>
    <div class="tw-bg-gray-100 tw-shadow-xl tw-rounded tw-p-10">
        <div class="tw-flex sm:tw-flex-row tw-flex-col tw-justify-between">
            <h2 class="tw-font-semibold tw-text-xl tw-leading-tight">
                <i class="fa-solid fa-circle-user text-main"></i>
                Dane użytkownika
            </h2>
            <p class="tw-text-blue-600 tw-font-bold tw-underline hover:tw-text-blue-900 hover:tw-cursor-pointer"
