<template>
    <div
        class="tw-bg-gray-700 tw-p-4 tw-flex tw-flex-row tw-text-gray-100 tw-absolute tw-w-full tw-h-full tw-top-0 tw-items-center tw-justify-center tw-opacity-80 tw-rounded tw-z-20">
