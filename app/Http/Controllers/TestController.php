...
class TestController extends Controller
{
    ...
    public function remove_file()
    {
        echo 'usuwanie pliku';
        try {
            Storage::disk('public_images')->delete('21950.jpg');
        } catch (\Throwable $th) {
            echo $th->getMessage();
        }
    }
    ...
    public function test_service()
    {
        ...
        $caretaker_docs = $document_service->full(23264);
        ...
        dd($is_registered);
        // dd($caretaker_docs->assignments[0]->contract);
    }
    ...
    public function test_sms()
    {
        $sms = new SMS;
        $sms->set_time();
        $sms->params['to'] = '723864128';
        $sms->params['message'] = 'Test SMS - z datą';
    ...
    // {
    //     $user_bonuses = UserHasBonus::all();

    //     foreach ($user_bonuses as $user_bonus) {
    //         if ($user_bonus->completed == true) {
    //             $user_bonus->bonus_status_id = 2;
    //             $user_bonus->save();
    //             continue;
    //         } else {
    //             $user_bonus->bonus_status_id = 1;
    //             $user_bonus->save();
    //         }
    //     }
    // }
    ...
    //             echo $user->user_profiles['last_name'] . '<br>';
    //             echo $days . '<br><br>';
